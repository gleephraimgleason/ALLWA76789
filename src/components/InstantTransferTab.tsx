  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 p-4 pb-24">
      <div className="max-w-lg mx-auto space-y-6">
        ...
        {/* Balance Card */}
        <Card className="bg-gradient-to-br from-blue-500/20 via-indigo-500/20 to-purple-600/20 backdrop-blur-md shadow-2xl border border-blue-400/30 text-white relative overflow-hidden">
          ...
          <CardContent className="p-8 text-center relative z-10">
            ...
            <div className="bg-white/10 rounded-2xl p-6 mb-4 border border-white/20">
              <p className="text-5xl font-bold text-white mb-2 tracking-tight">
                ...
                <span className="text-2xl text-blue-300 mr-2">دج</span>
              </p>
        ...
        {/* Transfer Form */}
        <Card className="bg-gradient-to-br from-green-500/20 via-emerald-500/20 to-teal-600/20 backdrop-blur-md shadow-2xl border border-green-400/30 text-white relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-green-400/5 via-emerald-400/5 to-teal-400/5 animate-pulse"></div>
          <CardHeader className="relative z-10">
            <CardTitle className="text-white text-2xl flex items-center justify-center gap-3">
              ...
              <div className="text-center">
                <h3 className="text-xl font-bold">بيانات التحويل الفوري</h3>
                <p className="text-sm text-green-200 font-normal">
          ...
          <CardContent className="space-y-8 pt-6 relative z-10">
            ...
            <div className="space-y-3">
              <label className="block text-white text-base font-semibold mb-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-sm text-green-200 font-normal">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="relative bg-white/15 border-2 border-white/20 text-white placeholder:text-gray-300 focus:border-green-400 focus:ring-2 focus:ring-green-400/50 h-14 pr-12 text-base font-medium rounded-xl backdrop-blur-sm"
                />
                <Search className="absolute right-4 top-1/2 transform -translate-y-1/2 text-green-400 w-5 h-5" />

                {/* Search Results */}
                {showSearchResults &&
                  searchResults.length > 0 &&
                  !selectedUser && (
                    <div className="absolute top-full left-0 right-0 bg-slate-800/95 backdrop-blur-md border-2 border-green-400/30 rounded-xl mt-2 max-h-48 overflow-y-auto z-50 shadow-2xl">
                      {searchResults.map((user, index) => (
                        <div
                          key={index}
                          className="p-4 hover:bg-green-500/20 cursor-pointer border-b border-gray-600/20 last:border-b-0 transition-all duration-200 hover:scale-[1.02]"
                          onClick={() => {
                ...
                {/* Selected User */}
                {selectedUser && (
                  <div className="absolute top-full left-0 right-0 bg-green-500/20 backdrop-blur-md border-2 border-green-400/50 rounded-xl mt-2 z-50 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  max="100000"
                  step="1"
                  className="relative bg-white/15 border-2 border-white/20 text-white placeholder:text-gray-300 focus:border-green-400 focus:ring-2 focus:ring-green-400/50 h-16 text-center text-3xl font-bold rounded-xl backdrop-blur-sm"
                />
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-green-400 font-bold text-xl">
                  دج
                </div>
              </div>
              <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                ...
                {amount && parseFloat(amount) > 0 && (
                  <div className="text-center text-base text-green-400 font-semibold bg-green-500/10 rounded-lg p-3 border border-green-500/20">
                    الرصيد بعد التحويل:{" "}
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="relative bg-white/15 border-2 border-white/20 text-white placeholder:text-gray-300 focus:border-green-400 focus:ring-2 focus:ring-green-400/50 h-14 text-base font-medium rounded-xl backdrop-blur-sm"
                />
              </div>
            </div>
            ...
            <div className="pt-4">
              <Button
                ...
                className="w-full h-16 bg-gradient-to-r from-green-500 via-emerald-600 to-teal-600 hover:from-green-600 hover:via-emerald-700 hover:to-teal-700 text-white font-bold text-xl disabled:opacity-50 disabled:cursor-not-allowed shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-2xl"
              >
                <div className="flex items-center justify-center gap-3">
                  <Zap className="w-6 h-6" />
                  <span>متابعة التحويل الفوري</span>
