...
function InstantTransferHistoryTab({
  ...
  const allTransactions = [
    ...instantTransfers.map((transfer) => ({
      ...
      description:
        ...
        (transfer.is_sender ? "تحويل فوري صادر" : "تحويل فوري وارد"),
  ...
  const getTransactionLabel = (
    ...
    if (isInstant) {
      return amount > 0 ? "تحويل فوري مستلم" : "تحويل فوري مرسل";
    }
    switch (type) {
      case "recharge":
        return "شحن المحفظة";
    ...
    <div className="space-y-6 pb-20 px-2 sm:px-0">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-300 text-lg">
          تاريخ جميع العمليات المالية والتحويلات الفورية
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="bg-gradient-to-br from-purple-500/20 to-pink-600/20 backdrop-blur-md border border-purple-400/30">
          <CardContent className="p-4 text-center">
            ...
            <p className="text-purple-200 text-xs mb-1">التحويلات الفورية</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select value={filter} onValueChange={setFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="instant">التحويلات الفورية</SelectItem>
