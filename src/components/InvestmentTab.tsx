    ...
    <div className="space-y-4 sm:space-y-6 pb-20 bg-transparent px-2 sm:px-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="bg-gradient-to-br from-blue-500/20 to-indigo-600/20 backdrop-blur-md border border-blue-400/30">
          <CardContent className="p-4 sm:p-6 text-center">
            <Wallet className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400 mx-auto mb-2" />
            <p className="text-blue-300 text-xs sm:text-sm">
              الرصيد المتاح للاستثمار
            </p>
            <p className="text-white font-bold text-xl sm:text-2xl mt-2">
              {balance.dzd?.toLocaleString() || "0"} دج
            </p>
            <p className="text-gray-300 text-xs mt-1">الرصيد الأساسي</p>
          </CardContent>
        </Card>

        <Card className="bg-gradient-to-br from-green-500/20 to-emerald-600/20 backdrop-blur-md border border-green-400/30">
          <CardContent className="p-4 sm:p-6 text-center">
            <BarChart3 className="w-8 h-8 sm:w-10 sm:h-10 text-green-400 mx-auto mb-2" />
            <p className="text-green-300 text-xs sm:text-sm">
              إجمالي المبلغ المستثمر
            </p>
            <p className="text-white font-bold text-xl sm:text-2xl mt-2">
              {(totalInvested || 0).toLocaleString()} دج
            </p>
            <p className="text-gray-300 text-xs mt-1">جميع الاستثمارات</p>
          </CardContent>
        </Card>
      </div>
      {/* Investment Performance */}
      <Card className="bg-gradient-to-br from-purple-500/20 to-pink-600/20 backdrop-blur-md border border-purple-400/30 shadow-lg">
        <CardContent className="p-4 sm:p-6 text-center">
          <LineChart className="w-10 h-10 sm:w-12 sm:h-12 text-purple-400 mx-auto mb-3" />
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div className="bg-purple-500/10 rounded-lg p-3">
              <p className="text-white font-bold text-lg sm:text-2xl">
                {totalInvested.toLocaleString()} دج
              </p>
              <p className="text-purple-300 text-xs">إجمالي الاستثمارات</p>
            </div>
            <div className="bg-green-500/10 rounded-lg p-3">
              <p className="text-green-400 font-bold text-lg sm:text-2xl">
                +{totalProfit.toLocaleString()} دج
              </p>
              <p className="text-purple-300 text-xs">إجمالي الأرباح</p>
            </div>
          </div>
          {totalInvested > 0 && (
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h3 className="text-white font-bold text-lg">عروض الاستثمار</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {investmentOptions.map((option) => (
            <Card
              key={option.id}
              className="bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/15 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3 space-x-reverse">
                    <div
                      className={`w-10 h-10 bg-gradient-to-r ${option.color} rounded-full flex items-center justify-center`}
                    >
                      {option.type === "weekly" ? (
                ...
                <div className="space-y-2 mb-3">
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400 text-xs">نسبة الربح</span>
                ...
                <Button
                  ...
                  className={`w-full bg-gradient-to-r ${option.color} hover:opacity-90 h-10 text-sm font-bold transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none border-0 rounded-xl relative overflow-hidden group`}
      ...
      {activeInvestments.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-white font-bold text-lg">الاستثمارات النشطة</h3>
      ...
      <Card className="bg-gradient-to-br from-red-500/20 to-orange-600/20 backdrop-blur-md border border-red-400/30">
        <CardContent className="p-4 sm:p-6">
          <h3 className="text-white font-bold text-base sm:text-lg mb-4 flex items-center">
